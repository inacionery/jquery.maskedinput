/*
    ...
    Copyright (c) 2007 - 2023 Josh Bush (digitalbush.com)
...
!function(factory) {
    ...
    $.mask = {
        ...
        mask: function(mask, settings) {
            ...
            firstNonMaskPos = null, chrome && android) {
                var allAllowedRegExps = "";
                jQuery.each(defs, function(key, value) {
                    allAllowedRegExps += key;
                }), allAllowedRegExps = allAllowedRegExps.replace(/\[/g, ""), allAllowedRegExps = allAllowedRegExps.replace(/\]/g, ""), 
                allAllowedRegExps = "[^" + allAllowedRegExps + "]";
                var re = new RegExp(allAllowedRegExps, "g"), actual = mask, replacedVal = actual.replace(re, ""), actualValue = actual.length - replacedVal.length;
                void 0 !== $(this).attr("maxlength") && $(this).attr("maxlength", parseInt(this.attr("maxlength")) + parseInt(actualValue));
            }
            return mask = String(mask), $.each(mask.split(""), function(i, c) {
